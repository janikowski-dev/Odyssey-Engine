...
namespace Core::Modules
{
    ...
    void SystemsModule::Init(const ApplicationConfig Config, Context& Context)
    {
        InitRendering();
        InitTime();
    ...
    void SystemsModule::Tick(const Context& Context)
    {
        HandleTime();
    ...
    void SystemsModule::InitSystems(const ApplicationConfig Config, Context& Context)
    {
    ...
    void SystemsModule::UpdateSystems(const Context& Context)
    {
